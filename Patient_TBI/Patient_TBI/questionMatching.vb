...
Module questionMatching
    ...
    Function directQueryMatching(ByVal sampleTableAdapter As Patient_TBIDataSetTableAdapters.Question_TBLTableAdapter, ByVal data As String) As Integer
        ' Find a direct match to the question
        Try
            Dim quesNo = sampleTableAdapter.SelectQuestion(data)
            Return quesNo
        Catch
            Return -1
        End Try
    ...
    Function questionCount(ByVal sampleTableAdapter As Patient_TBIDataSetTableAdapters.Question_TBLTableAdapter)
        Return sampleTableAdapter.SelectCountQ_ID()
    End Function

    ' Function to return question to write to text file
    Function question(ByVal sampleTableAdapter As Patient_TBIDataSetTableAdapters.Question_TBLTableAdapter, ByVal quesNo As Integer)
    ...
    Function retrieveAnswer(ByVal sampleTableAdapter As Patient_TBIDataSetTableAdapters.Question_TBLTableAdapter, ByVal quesNo As Integer)
